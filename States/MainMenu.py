...
class MainMenu:
    ...
    def __init__(self, screen):
        ...
        self.game_name_sprite.rect = (game_name_text_x, game_name_text_y, game_name_text_w, game_name_text_h)
        ...
        self.menu_image.image = pygame.transform.scale(load_image("main_menu_image.png"), (700, 600))
    ...
    def on_leaderboard_click(self, event):
